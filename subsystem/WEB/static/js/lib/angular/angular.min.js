...
(function (Q, V, t) {
 ...
 function G(b) {
  return function () {
   var a = arguments[0], c;
   c = "[" + (b ? b + ":" : "") + a + "] http://errors.angularjs.org/1.4.0-rc.1/" + (b ? b + "/" : "") + a;
 ...
 function Qa(b) {
  ...
  var a = b.length;
  return b.nodeType ===
  na && a ? !0 : M(b) || L(b) || 0 === a || "number" === typeof a && 0 < a && a - 1 in b
 }

 function n(b, a, c) {
  var d, e;
  if (b)if (E(b))for (d in b)"prototype" == d || "length" == d || "name" == d || b.hasOwnProperty && !b.hasOwnProperty(d) || a.call(c, b[d], d, b); else if (L(b) || Qa(b)) {
   var f = "object" !== typeof b;
   d = 0;
   for (e = b.length; d < e; d++)(f || d in b) && a.call(c, b[d], d, b)
  } else if (b.forEach && b.forEach !== n)b.forEach(a, c, b); else for (d in b)b.hasOwnProperty(d) && a.call(c, b[d], d, b);
  return b
 }
 ...
 function Kb(b, a, c) {
  for (var d = b.$$hashKey, e = 0, f = a.length; e < f; ++e) {
   var g = a[e];
   if (D(g) || E(g))for (var h = Object.keys(g), l = 0, k = h.length; l < k; l++) {
    var m = h[l], r = g[m];
    c && D(r) ? (D(b[m]) || (b[m] = L(r) ? [] : {}), Kb(b[m], [r], !0)) : b[m] = r
   }
  }
  lc(b, d);
  return b
 ...
 function O(b) {
  return Kb(b, pa.call(arguments, 1), !1)
 }

 function Pd(b) {
  return Kb(b, pa.call(arguments, 1), !0)
 }
 ...
 function Ta(b) {
  return "[object RegExp]" === qa.call(b)
 }
 ...
 function sa(b, a, c, d) {
  if (Ra(b) || Ua(b))throw Ca("cpws");
  if (nc.test(qa.call(a)))throw Ca("cpta");
  if (a) {
   if (b === a)throw Ca("cpi");
   c = c || [];
   d = d || [];
   ...
   if (L(b))for (var f = a.length = 0; f < b.length; f++)e = sa(b[f], null, c, d), D(b[f]) && (c.push(b[f]), d.push(e)), a.push(e); else {
    var g = a.$$hashKey;
    L(a) ? a.length = 0 : n(a, function (b, c) {
     delete a[c]
    });
    for (f in b)b.hasOwnProperty(f) && (e = sa(b[f], null, c, d), D(b[f]) && (c.push(b[f]), d.push(e)), a[f] = e);
    lc(a, g)
   }
  } else if (a = b)L(b) ? a = sa(b, [], c, d) : nc.test(qa.call(b)) ? a = new b.constructor(b) : ea(b) ? a = new Date(b.getTime()) : Ta(b) ? (a = new RegExp(b.source,
      b.toString().match(/[^\/]*$/)[0]), a.lastIndex = b.lastIndex) : D(b) && (e = Object.create(Object.getPrototypeOf(b)), a = sa(b, e, c, d));
  return a
 }
 ...
 function ja(b, a) {
  ...
  if (c == typeof a && "object" == c)if (L(b)) {
   ...
   if ((c = b.length) == a.length) {
    for (d = 0; d <
    c; d++)if (!ja(b[d], a[d]))return !1;
    return !0
   }
  } else {
   if (ea(b))return ea(a) ? ja(b.getTime(), a.getTime()) : !1;
   if (Ta(b))return Ta(a) ? b.toString() == a.toString() : !1;
   if (Ua(b) || Ua(a) || Ra(b) || Ra(a) || L(a) || ea(a) || Ta(a))return !1;
   c = {};
   for (d in b)if ("$" !== d.charAt(0) && !E(b[d])) {
    if (!ja(b[d], a[d]))return !1;
    c[d] = !0
   }
   for (d in a)if (!c.hasOwnProperty(d) && "$" !== d.charAt(0) && a[d] !== t && !E(a[d]))return !1;
   return !0
  }
  return !1
 }
 ...
 function Xa(b, a, c) {
  return b.concat(pa.call(a, c))
 }

 function oc(b, a) {
  var c = 2 < arguments.length ? pa.call(arguments,
      2) : [];
 ...
 function Rd(b, a) {
  var c = a;
  "string" === typeof b && "$" === b.charAt(0) && "$" === b.charAt(1) ? c = t : Ra(a) ? c = "$WINDOW" : a && V === a ? c = "$DOCUMENT" : Ua(a) && (c = "$SCOPE");
  return c
 }
 ...
 function Mb(b, a, c) {
  c = c ? -1 : 1;
  var d = qc(a, b.getTimezoneOffset());
  a = b;
 ...
 function ta(b) {
  ...
  try {
   return b[0].nodeType === Za ? F(c) : c.match(/^(<[^>]+>)/)[1].replace(/^<([\w\-]+)/, function (a, b) {
    return "<" + F(b)
   })
  } catch (d) {
   return F(c)
 ...
 function sc(b) {
  ...
  n((b || "").split("&"), function (b) {
   b && (c = b.replace(/\+/g, "%20").split("="), d = rc(c[0]), z(d) && (b = z(c[1]) ? rc(c[1]) : !0, tc.call(a, d) ? L(a[d]) ? a[d].push(b) : a[d] = [a[d], b] : a[d] = b))
  });
  return a
 }
 ...
 function Sd(b, a) {
  var c, d, e = Ka.length;
  for (d = 0; d < e; ++d)if (c = Ka[d] + a, M(c = b.getAttribute(c)))return c;
  return null
 }
 ...
 function Td(b, a) {
  ...
  c && (e.strictDi = null !== Sd(c, "strict-di"),
      a(c, d ? [d] : [], e))
 }
 ...
 function uc(b, a, c) {
  ...
  var d = function () {
   ...
   if (b.injector()) {
    ...
    throw Ca("btstrpd", d.replace(/</, "&lt;").replace(/>/, "&gt;"));
   }
   a = a || [];
 ...
 function vc(b, a) {
  a = a || "_";
  return b.replace(Wd, function (b, d) {
 ...
 function Xd() {
  ...
  if (!wc) {
   ...
   ka = Q.jQuery;
   z(a) && (ka = null === a ? t : Q[a]);
   ka && ka.fn.on ? (C = ka, O(ka.fn, {
    scope: La.scope,
    isolateScope: La.isolateScope,
    controller: La.controller,
    injector: La.injector,
    inheritedData: La.inheritedData
   }), b = ka.cleanData, ka.cleanData = function (a) {
    var d;
    if (Ob)Ob = !1; else for (var e = 0, f; null != (f = a[e]); e++)(d = ka._data(f, "events")) && d.$destroy && ka(f).triggerHandler("$destroy");
    b(a)
   }) : C = P;
   ba.element =
       C;
 ...
 function Pb(b, a, c) {
  if (!b)throw Ca("areq", a || "?", c || "required");
  return b
 }

 function Ma(b, a, c) {
  c && L(b) && (b = b[b.length - 1]);
  Pb(E(b), a, "not a function, got " + (b && "object" === typeof b ? b.constructor.name || "Object" : typeof b));
  return b
 }

 function Na(b, a) {
  if ("hasOwnProperty" === b)throw Ca("badname", a);
 }
  ...
  return a(b, "module", function () {
   ...
   return function (f, g, h) {
    ...
    return a(b, f, function () {
     ...
     if (!g)throw c("nomod",
         f);
     var b = [], d = [], e = [], s = a("$injector", "invoke", "push", d), y = {
      _invokeQueue: b,
      _configBlocks: d,
      _runBlocks: e,
      requires: g,
 ...
 function Zd(b) {
  O(b, {
   ...
   $$minErr: G,
   $$csp: ab,
   reloadWithDebugInfo: Ud
  });
  bb = Yd(Q);
  try {
   bb("ngLocale")
  } catch (a) {
   bb("ngLocale", []).provider("$locale",
       ae)
  }
  bb("ng", ["ngLocale"], ["$provide", function (a) {
   ...
   a.provider("$compile", yc).directive({
    ...
    ngValue: Ie,
    ngModelOptions: Je
   }).directive({ngInclude: Ke}).directive(ob).directive(Ec);
   a.provider({
    $anchorScroll: Le,
    $animate: Me,
    $$animateQueue: Ne,
 ...
 function cb(b) {
  return b.replace(tf, function (a, b, d, e) {
 ...
 function Hc(b, a) {
  ...
  if (Qb.test(b)) {
   ...
   d = (vf.exec(b) || ["", ""])[1].toLowerCase();
   d = ga[d] || ga._default;
   c.innerHTML = d[1] + b.replace(wf, "<$1></$2>") + d[2];
 ...
 function P(b) {
  ...
  if (!(this instanceof P)) {
   if (a && "<" != b.charAt(0))throw Rb("nosel");
   return new P(b)
  }
  if (a) {
   a = V;
   var c;
   b = (c = xf.exec(b)) ? [a.createElement(c[1])] :
       (c = Hc(b, a)) ? c.childNodes : []
  }
  Ic(this, b)
 }
 ...
 function Jc(b, a, c, d) {
  ...
  var e = (d = rb(b)) && d.events, f = d && d.handle;
 ...
 function qb(b,
             a) {
  var c = b.ng339, d = c && sb[c];
  d && (a ? delete d.data[a] : (d.handle && (d.events.$destroy && d.handle({}, "$destroy"), Jc(b)), delete sb[c], b.ng339 = t))
 }

 function rb(b, a) {
  var c = b.ng339, c = c && sb[c];
  a && !c && (b.ng339 = c = ++yf, c = sb[c] = {events: {}, data: {}, handle: t});
  return c
 }

 function Tb(b, a, c) {
  if (Gc(b)) {
   var d = z(c), e = !d && a && !D(a), f = !a;
   b = (b = rb(b, !e)) && b.data;
   if (d)b[a] = c; else {
    if (f)return b;
    if (e)return b && b[a];
 ...
 function ub(b, a) {
  a && b.setAttribute && n(a.split(" "), function (a) {
   b.setAttribute("class", S((" " + (b.getAttribute("class") || "") + " ").replace(/[\n\t]/g, " ").replace(" " + S(a) + " ", " ")))
  })
 }
 ...
 function wb(b, a, c) {
  ...
  for (a = L(a) ? a : [a]; b;) {
   for (var d = 0, e = a.length; d < e; d++)if ((c = C.data(b, a[d])) !== t)return c;
   b = b.parentNode || 11 === b.nodeType && b.host
  }
 }

 function Lc(b) {
  for (pb(b, !0); b.firstChild;)b.removeChild(b.firstChild)
 }
 ...
 function Da(b, a) {
  ...
  c = typeof b;
  return c = "function" ==
  c || "object" == c && null !== b ? b.$$hashKey = c + ":" + (a || Od)() : c + ":" + b
 }
 ...
 function $a(b, a) {
  function c(a) {
   return function (b, c) {
    if (D(b))n(b, kc(a)); else return a(b, c)
   }
  }

  function d(a, b) {
   Na(a, "service");
   if (E(b) || L(b))b = s.instantiate(b);
  ...
  function g(a) {
   ...
   n(a, function (a) {
    ...
    if (!m.get(a)) {
     m.put(a, !0);
     try {
      M(a) ? (c = bb(a), b = b.concat(g(c.requires)).concat(c._runBlocks), d(c._invokeQueue), d(c._configBlocks)) : E(a) ? b.push(s.invoke(a)) : L(a) ? b.push(s.invoke(a)) : Ma(a, "module")
     } catch (e) {
      throw L(a) && (a = a[a.length - 1]), e.message && e.stack && -1 ==
  ...
  function h(b, c) {
   ...
   function e(b, c, f, g) {
    ...
    var h = [], k = $a.$$annotate(b, a, g), l, s, m;
    s = 0;
    for (l = k.length; s < l; s++) {
     m = k[s];
     if ("string" !== typeof m)throw Ea("itkn", m);
     h.push(f &&
     f.hasOwnProperty(m) ? f[m] : d(m, g))
    }
    L(b) && (b = b[l]);
    return b.apply(c, h)
   }
   ...
   return {
    invoke: e, instantiate: function (a, b, c) {
     ...
     a = e(a, d, b, c);
     return D(a) || E(a) ? a : d
    }, get: d, annotate: $a.$$annotate, has: function (a) {
  ...
  }), y = {}, H = y.$injector = h(y, function (a, b) {
   var c = s.get(a + "Provider", b);
   return H.invoke(c.$get, c, t, a)
  });
  n(g(b), function (a) {
   H.invoke(a || x)
  });
  ...
  this.$get = ["$window", "$location", "$rootScope", function (a, c, d) {
   ...
   function f(b) {
    if (b) {
     ...
     var c;
     c = g.yOffset;
     E(c) ? c = c() : mc(c) ? (c = c[0], c = "fixed" !== a.getComputedStyle(c).position ? 0 : c.getBoundingClientRect().bottom) : T(c) || (c = 0);
 ...
 function Ef(b, a, c, d) {
  function e(a) {
   try {
    a.apply(null, pa.call(arguments, 1))
   } finally {
    if (H--, 0 === H)for (; J.length;)try {
     J.pop()()
    } catch (b) {
     c.error(b)
    }
  ...
  function h() {
   if (w !== l.url() || p !== u)w = l.url(), p = u, n(B, function (a) {
    a(l.url(), u)
   })
  }

  var l = this, k = b.location, m = b.history, r = b.setTimeout, s = b.clearTimeout, y = {};
  l.isMock = !1;
  var H = 0, J = [];
  ...
  var u, p, w = k.href, q = a.find("base"), K = null;
  g();
  p = u;
  l.url = function (a, c, e) {
   ...
   if (a) {
    var f = p === e;
    if (w === a && (!d.history || f))return l;
    var h = w && Fa(w) === Fa(a);
    w = a;
    p = e;
    !d.history || h && f ? (h || (K = a), c ? k.replace(a) : h ? (c = k, e = a.indexOf("#"), a = -1 === e ? "" : a.substr(e + 1), c.hash = a) : k.href = a) : (m[c ? "replaceState" : "pushState"](e, "", a), g(), p = u);
    return l
   }
   return K || k.href.replace(/%27/g,
           "'")
  };
  l.state = function () {
   return u
 ...
 function Qe() {
  this.$get = function () {
   function b(b, d) {
    ...
    var g = 0, h = O({}, d, {id: b}), l = {}, k = d && d.capacity || Number.MAX_VALUE, m = {}, r = null, s = null;
    return a[b] = {
     put: function (a, b) {
      if (!v(b)) {
 ...
 function yc(b, a) {
  ...
  var e = {}, f = /^\s*directive\:\s*([\w\-]+)\s+(.*)$/,
      g = /(([\w\-]+)(?:\:([^;]+))?;?)/, h = Qd("ngSrc,ngSrcset,src,srcset"), l = /^(?:(\^\^?)?(\?)?(\^\^?)?)?/, k = /^(on[a-z]+|formaction)$/;
  this.directive = function s(a, f) {
   Na(a, "directive");
   M(a) ? (d(a), Pb(f, "directiveFactory"), e.hasOwnProperty(a) || (e[a] = [], b.factory(a + "Directive", ["$injector", "$exceptionHandler", function (b, d) {
    var f = [];
    n(e[a], function (e, g) {
     try {
      var h = b.invoke(e);
      E(h) ? h = {compile: oa(h)} : !h.compile && h.link && (h.compile = oa(h.link));
      ...
      if (D(m.bindToController)) {
       var H = k.controller, Z = k.controllerAs;
       if (!H)throw ha("noctrl", s);
       var da;
       a:if (Z && M(Z))da = Z; else {
        if (M(H)) {
         var n = Rc.exec(H);
         if (n) {
          da = n[3];
       ...
       if (!da)throw ha("noident",
           s);
      }
      var q = l.$$bindings = m;
      D(q.isolateScope) && (h.$$isolateBindings = q.isolateScope);
      f.push(h)
     } catch (t) {
      d(t)
     }
  ...
  this.$get = ["$injector",
   "$interpolate", "$exceptionHandler", "$templateRequest", "$parse", "$controller", "$rootScope", "$document", "$sce", "$animate", "$$sanitizeUri", function (a, b, c, d, u, p, w, q, K, B, N) {
    function A(a, b) {
     try {
      a.addClass(b)
     } catch (c) {
    ...
    function R(a, b, c, d, e) {
     ...
     n(a, function (b, c) {
      b.nodeType == Za && b.nodeValue.match(/\S+/) && (a[c] = C(b).wrap("<span></span>").parent()[0])
     });
     var f = Y(a, b, a, c, d, e);
     R.$$addScopeClass(a);
     var g = null;
     return function (b, c, d) {
      ...
      g || (g = (d = d && d[0]) ? "foreignobject" !== ra(d) && d.toString().match(/SVG/) ? "svg" : "html" : "html");
      d = "html" !== g ? C(Vb(g, C("<div>").append(a).html())) : c ? La.clone.call(a) : a;
    ...
    function Y(a, b, c, d, e, f) {
     function g(a, c, d, e) {
      ...
      m = 0;
      for (s = h.length; m <
      s;)if (k = y[h[m++]], c = h[m++], f = h[m++], c) {
       if (c.scope) {
        if (l = a.$new(), R.$$addScopeInfo(C(k), l), B = c.$$destroyBindings)c.$$destroyBindings = null, l.$on("$destroyed", B)
       } else l = a;
       B = c.transcludeOnThisElement ? Z(a, c.transclude, e, c.elementTranscludeOnThisElement) : !c.templateOnThisElement && e ? e : !e && b ? Z(a, b) : null;
       c(f, l, k, d, B, c)
      } else f && f(a, k.childNodes, t, e)
     }

     for (var h = [], k, l, m, s, p, B = 0; B < a.length; B++) {
      k = new ca;
      l = da(a[B], [], k, 0 === B ? d : t, e);
      (f = l.length ? I(l, a[B], k, b, c, null, [], [], f) : null) && f.scope && R.$$addScopeClass(k.$$element);
      k = f && f.terminal || !(m = a[B].childNodes) || !m.length ? null : Y(m, f ? (f.transcludeOnThisElement || !f.templateOnThisElement) && f.transclude : b);
      if (f || k)h.push(B, f, k), s = !0, p = p || f;
      f = null
     }
     return s ? g : null
    }
    ...
    function da(a, b, c, d, e) {
     ...
     switch (a.nodeType) {
      case na:
       v(b, wa(ra(a)), "E", d, e);
       for (var l, m, s, p = a.attributes, B = 0, y = p && p.length; B <
       y; B++) {
        var H = !1, Z = !1;
        l = p[B];
        k = l.name;
        m = S(l.value);
        l = wa(k);
        if (s = ia.test(l))k = k.replace(Tc, "").substr(8).replace(/_(.)/g, function (a, b) {
         return b.toUpperCase()
        });
        var J = l.replace(/(Start|End)$/, "");
        G(J) && l === J + "Start" && (H = k, Z = k.substr(0, k.length - 5) + "end", k = k.substr(0, k.length - 6));
        l = wa(k.toLowerCase());
        h[l] = k;
        if (s || !c.hasOwnProperty(l))c[l] = m, Mc(a, l) && (c[l] = !0);
        U(a, b, m, l, s);
        v(b, l, "A", d, e, H, Z)
       }
       a = a.className;
       D(a) && (a = a.animVal);
       if (M(a) && "" !== a)for (; k = g.exec(a);)l = wa(k[2]), v(b, l, "C", d, e) && (c[l] = S(k[3])), a =
      ...
      case 8:
       try {
        if (k = f.exec(a.nodeValue))l = wa(k[1]), v(b, l, "M", d, e) && (c[l] = S(k[2]))
       } catch (N) {
       }
     }
     b.sort(Ga);
    ...
    function I(a,
     ...
     function s(a, b, c, d) {
      if (a) {
       ...
       a.require = I.require;
       a.directiveName = x;
       if (A === I || I.$$isolateScope)a = $(a, {isolateScope: !0});
       h.push(a)
      }
      if (b) {
       c && (b = Sc(b, c, d));
       b.require = I.require;
       b.directiveName = x;
       if (A === I || I.$$isolateScope)b = $(b, {isolateScope: !0});
       k.push(b)
      }
     }
     ...
     function B(a, b, c, d) {
      ...
      } else if (L(b))for (e = [], g = 0, f = b.length; g < f; g++)e[g] = B(a, b[g], c, d);
      return e || null
     }
     ...
     function Z(a, c, e, f, g, l) {
      ...
      var s, p, H, J,
          n, eb, w;
      b === e ? (f = d, w = d.$$element) : (w = C(e), f = new ca(w, d));
      A && (J = c.$new(!0));
      g && (eb = m, eb.$$boundTransclude = g);
      Y && (n = y(w, f, eb, Y, J, c));
      A && (R.$$addScopeInfo(w, J, !0, !(u && (u === A || u === A.$$originalDirective))), R.$$addScopeClass(w, !0), J.$$isolateBindings = A.$$isolateBindings, ba(c, f, J, J.$$isolateBindings, A, J));
      if (n) {
       var da = A || N, K;
       da && n[da.name] && (p = da.$$bindings.bindToController, (H = n[da.name]) && H.identifier && p && (K = H, l.$$destroyBindings = ba(c, f, H.instance, p, da)));
       for (s in n) {
        H = n[s];
        var va = H();
        va !== H.instance && (H.instance =
            va, w.data("$" + I.name + "Controller", va), H === K && (l.$$destroyBindings(), l.$$destroyBindings = ba(c, f, va, p, da)))
       }
      }
      s = 0;
      for (l = h.length; s < l; s++)p = h[s], aa(p, p.isolateScope ? J : c, w, f, p.require && B(p.directiveName, p.require, w, n), eb);
      var W = c;
      A && (A.template || null === A.templateUrl) && (W = J);
      a && a(W, e.childNodes, t, g);
      for (s = k.length - 1; 0 <= s; s--)p = k[s], aa(p, p.isolateScope ? J : c, w, f, p.require && B(p.directiveName, p.require, w, n), eb)
     }

     m = m || {};
     for (var J = -Number.MAX_VALUE, N, Y = m.controllerDirectives, A = m.newIsolateScopeDirective, u = m.templateDirective,
              n = m.nonTlbTranscludeDirective, w = !1, K = !1, q = m.hasElementTranscludeDirective, W = d.$$element = C(b), I, x, v, Ga = e, ya, G = 0, F = a.length; G < F; G++) {
      I = a[G];
      var O = I.$$start, Wb = I.$$end;
      O && (W = va(b, O, Wb));
      v = t;
      if (J > I.priority)break;
      if (v = I.scope)I.templateUrl || (D(v) ? (P("new/isolated scope", A || N, I, W), A = I) : P("new/isolated scope", A, I, W)), N = N || I;
      x = I.name;
      !I.templateUrl && I.controller && (v = I.controller, Y = Y || la(), P("'" + x + "' controller", Y[x], I, W), Y[x] = I);
      if (v = I.transclude)w = !0, I.$$tlb || (P("transclusion", n, I, W), n = I), "element" == v ?
          (q = !0, J = I.priority, v = W, W = d.$$element = C(V.createComment(" " + x + ": " + d[x] + " ")), b = W[0], X(f, pa.call(v, 0), b), Ga = R(v, e, J, g && g.name, {nonTlbTranscludeDirective: n})) : (v = C(Sb(b)).contents(), W.empty(), Ga = R(v, e));
      if (I.template)if (K = !0, P("template", u, I, W), u = I, v = E(I.template) ? I.template(W, d) : I.template, v = ga(v), I.replace) {
       g = I;
       v = Qb.test(v) ? Uc(Vb(I.templateNamespace, S(v))) : [];
       b = v[0];
       if (1 != v.length || b.nodeType !== na)throw ha("tplrt", x, "");
       X(f, W, b);
       F = {$attr: {}};
       v = da(b, [], F);
       var T = a.splice(G + 1, a.length - (G + 1));
       A && z(v);
       a = a.concat(v).concat(T);
       Q(d, F);
       F = a.length
      } else W.html(v);
      if (I.templateUrl)K = !0, P("template", u, I, W), u = I, I.replace && (g = I), Z = Ff(a.splice(G, a.length - G), W, d, f, w && Ga, h, k, {
       controllerDirectives: Y,
       newIsolateScopeDirective: A,
       templateDirective: u,
       nonTlbTranscludeDirective: n
      }), F = a.length; else if (I.compile)try {
       ya = I.compile(W, d, Ga), E(ya) ? s(null, ya, O, Wb) : ya && s(ya.pre, ya.post, O, Wb)
      } catch (U) {
       c(U, ta(W))
      }
      I.terminal && (Z.terminal = !0, J = Math.max(J, I.priority))
     }
     Z.scope = N && !0 === N.scope;
     Z.transcludeOnThisElement = w;
     Z.elementTranscludeOnThisElement =
         q;
     Z.templateOnThisElement = K;
     Z.transclude = Ga;
    ...
    function z(a) {
     for (var b = 0, c = a.length; b < c; b++)a[b] = Lb(a[b], {$$isolateScope: !0})
    }

    function v(b, d, f, g, h, k, l) {
     if (d === h)return null;
     h = null;
     if (e.hasOwnProperty(d)) {
      ...
      for (var p = 0, B = d.length; p < B; p++)try {
       m = d[p], (g === t || g > m.priority) && -1 != m.restrict.indexOf(f) && (k && (m = Lb(m, {
        $$start: k,
        $$end: l
       })), b.push(m), h = m)
      } catch (y) {
    ...
    function Ff(a, b, c, e, f, g, h, k) {
     var l = [], m, s, p = b[0],
         B = a.shift(), y = Lb(B, {
          ...
          replace: null,
          $$originalDirective: B
         }), H = E(B.templateUrl) ? B.templateUrl(b, c) : B.templateUrl, N = B.templateNamespace;
     b.empty();
     d(K.getTrustedResourceUrl(H)).then(function (d) {
      var J, u;
      d = ga(d);
      if (B.replace) {
       d = Qb.test(d) ? Uc(Vb(N, S(d))) : [];
       J = d[0];
       if (1 != d.length || J.nodeType !== na)throw ha("tplrt", B.name, H);
       d = {$attr: {}};
       X(e, b, J);
       var w = da(J, [], d);
       D(B.scope) && z(w);
      ...
      a.unshift(y);
      m = I(a, J, c, f, b, B, g, h, k);
      n(e, function (a, c) {
       a ==
       J && (e[c] = b[0])
      });
      for (s = Y(b[0].childNodes, f); l.length;) {
       d = l.shift();
       u = l.shift();
       var K = l.shift(), R = l.shift(), w = b[0];
       if (!d.$$destroyed) {
        if (u !== p) {
         var va = u.className;
         k.hasElementTranscludeDirective && B.replace || (w = Sb(J));
         X(K, C(u), w);
         A(C(w), va)
        }
        u = m.transcludeOnThisElement ? Z(d, m.transclude, R) : R;
        m(s, d, w, e, u, m)
       }
      }
      l = null
     ...
     return function (a, b, c, d, e) {
      a = e;
      b.$$destroyed || (l ? l.push(b, c, d, a) : (m.transcludeOnThisElement && (a = Z(b, m.transclude, e)), m(s, b, c, d, a, m)))
     }
    }
    ...
    function P(a, b, c, d) {
     if (b)throw ha("multidir", b.name, c.name, a, ta(d));
    }
    ...
    function U(a, c, d, e, f) {
     ...
     var l = b(d, !0, g, f);
     if (l) {
      if ("multiple" === e && "select" === ra(a))throw ha("selmulti", ta(a));
      c.push({
       priority: 100, compile: function () {
        return {
         pre: function (a, c, h) {
          c = h.$$observers || (h.$$observers = {});
          if (k.test(e))throw ha("nodomevents");
          var m = h[e];
    ...
    function X(a, b, c) {
     ...
     a.appendChild(d);
     C(c).data(C(d).data());
     ka ? (Ob = !0, ka.cleanData([d])) : delete C.cache[d[C.expando]];
     d = 1;
    ...
    function ba(a, c, d, e, f, g) {
     var h;
     n(e, function (e, g) {
      var k = e.attrName, l = e.optional, m, s, p, B;
      switch (e.mode) {
       case "@":
       ...
       case "=":
        ...
        l.$stateful = !0;
        l = e.collection ? a.$watchCollection(c[k], l) : a.$watch(u(c[k], l), null, s.literal);
        h = h || [];
        h.push(l);
        break;
       case "&":
    ...
    ca.prototype = {
     ...
     $set: function (a, b, d, e) {
      var f = this.$$element[0], g = Mc(f, a), h = Af(f, a), f = a;
      ...
      if ("a" === g && "href" === a || "img" === g && "src" === a)this[a] = b = N(b, "src" === a); else if ("img" === g && "srcset" === a) {
       for (var g = "", h = S(b), k = /(\s+\d+x\s*,|\s+\d+w\s*,|\s+,|,\s+)/, k = /\s/.test(h) ? k : /(,)/, h = h.split(k), k = Math.floor(h.length / 2), l = 0; l < k; l++)var m = 2 * l, g = g + N(S(h[m]), !0), g = g + (" " + S(h[m + 1]));
       h = S(h[2 * l]).split(/\s/);
       g += N(S(h[0]), !0);
       2 === h.length && (g += " " + S(h[1]));
       this[a] = b = g
      ...
      var c = this, d = c.$$observers || (c.$$observers = la()), e = d[a] || (d[a] = []);
      e.push(b);
    ...
    var ea = b.startSymbol(), fa = b.endSymbol(), ga = "{{" == ea || "}}" == fa ? Sa : function (a) {
     return a.replace(/\{\{/g,
         ea).replace(/}}/g, fa)
    }, ia = /^ngAttr[A-Z]/;
    R.$$addBindingInfo = m ? function (a, b) {
     var c = a.data("$binding") || [];
     L(b) ? c = c.concat(b) : c.push(b);
     a.data("$binding", c)
    } : x;
    R.$$addBindingClass = m ? function (a) {
     A(a, "ng-binding")
    } : x;
    R.$$addScopeInfo = m ? function (a, b, c, d) {
     a.data(c ? d ? "$isolateScopeNoTemplate" : "$isolateScope" : "$scope", b)
    } : x;
    R.$$addScopeClass = m ? function (a, b) {
 ...
 function Uc(b) {
  ...
  var a = b.length;
  if (1 >= a)return b;
  for (; a--;)8 === b[a].nodeType && Gf.call(b, a, 1);
  return b
 }
 ...
 function Re() {
  ...
  this.$get = ["$injector", "$window", function (c, d) {
   ...
   return function (f,
    ...
    if (M(f)) {
     l = f.match(Rc);
     if (!l)throw Hf("ctrlfmt", f);
     m = l[1];
     r = r || l[3];
     f = b.hasOwnProperty(m) ? b[m] : xc(g.$scope, m, !0) || (a ? xc(d, m, !0) : t);
     Ma(f, m, !0)
    }
    if (h)return h = (L(f) ? f[f.length - 1] : f).prototype, k = Object.create(h || null), r && e(g, r, k, m || f.name), O(function () {
     var a = c.invoke(f, k, g, m);
     a !== k && (D(a) || E(a)) && (k = a, r && e(g, r, k, m || f.name));
     return k
 ...
 function Wc(b) {
  function a(a) {
   return D(a) ? ea(a) ? a.toISOString() : Ya(a) : a
  }
  ...
  return function (c) {
   ...
   var d = [];
   Nd(c, function (c, f) {
    null === c || v(c) || (L(c) || D(c) && b ? n(c, function (g, h) {
     var l = b ? "[" + (L(c) ? "" : h) + "]" : "";
     d.push(ua(f + l) + "=" + ua(a(g)))
    }) : d.push(ua(f) + "=" + ua(a(c))))
   });
 ...
 function Xb(b, a) {
  if (M(b)) {
   var c = b.replace(If, "").trim();
   if (c) {
    var d = a("Content-Type");
    (d = d && 0 === d.indexOf(Xc)) || (d = (d = c.match(Jf)) && Kf[d[0]].test(c));
    d && (b = pc(c))
   }
  }
  return b
 ...
 function Zc(b) {
  ...
  return function (c) {
   a || (a = Yc(b));
   return c ? (c = a[F(c)], void 0 === c && (c = null),
       c) : a
  }
 }
 ...
 function We() {
  var b = this.defaults = {
   ...
   transformRequest: [function (a) {
    return D(a) && "[object File]" !== qa.call(a) && "[object Blob]" !== qa.call(a) && "[object FormData]" !== qa.call(a) ? Ya(a) : a
   }],
   headers: {common: {Accept: "application/json, text/plain, */*"}, post: fa(Yb), put: fa(Yb), patch: fa(Yb)},
  ...
  this.$get = ["$httpBackend", "$$cookieReader", "$cacheFactory", "$rootScope", "$q", "$injector", function (d, e, f, g, h, l) {
   function k(a) {
    function c(a) {
     var b = O({}, a);
     b.data = a.data ? $c(a.data, a.headers, a.status, e.transformResponse) : a.data;
     a = a.status;
    ...
    if (!ba.isObject(a))throw G("$http")("badreq", a);
    var e = O({
     method: "get",
     transformRequest: b.transformRequest, transformResponse: b.transformResponse, paramSerializer: b.paramSerializer
    }, a);
    e.headers = function (a) {
     var c = b.headers, e = O({}, a.headers), f, g, h, c = O({}, c.common, c[F(a.method)]);
     a:for (f in c) {
      g = F(f);
    ...
    e.method = nb(e.method);
    e.paramSerializer = M(e.paramSerializer) ? l.get(e.paramSerializer) : e.paramSerializer;
    var f = [function (a) {
     var d = a.headers, e = $c(a.data, Zc(d), t, a.transformRequest);
   ...
   function m(c, f) {
    function l(b, c, d, e) {
     ...
     N && (200 <= b && 300 > b ? N.put(Y, [b, c, Yc(d), e]) : N.remove(Y));
     a ? g.$applyAsync(f) : (f(), g.$$phase || g.$apply())
    }

    function m(a, b, d, e) {
     b = Math.max(b, 0);
     (200 <= b && 300 > b ? K.resolve : K.reject)({data: a, status: b, headers: Zc(d), config: c, statusText: e})
    }
    ...
    var K = h.defer(), B = K.promise,
        N, A, R = c.headers, Y = r(c.url, c.paramSerializer(c.params));
    k.pendingRequests.push(c);
    B.then(n, n);
    !c.cache && !b.cache || !1 === c.cache || "GET" !== c.method && "JSONP" !== c.method || (N = D(c.cache) ? c.cache : D(b.cache) ? b.cache : s);
    N && (A = N.get(Y), z(A) ? A && E(A.then) ? A.then(y, y) : L(A) ? m(A[1], A[0], fa(A[2]), A[3]) : m(A, 200, {}, "OK") : N.put(Y, B));
    v(A) && ((A = ad(c.url) ? e()[c.xsrfCookieName || b.xsrfCookieName] : t) && (R[c.xsrfHeaderName || b.xsrfHeaderName] = A), d(c.method, Y, f, l, R, c.timeout, c.withCredentials, c.responseType));
    return B
   }
   ...
   var s = f("$http");
   b.paramSerializer = M(b.paramSerializer) ? l.get(b.paramSerializer) : b.paramSerializer;
   var y = [];
   n(c, function (a) {
    y.unshift(M(a) ? l.get(a) : l.invoke(a))
   });
   k.pendingRequests = [];
   (function (a) {
    n(arguments, function (a) {
     k[a] = function (b, c) {
      return k(O(c || {}, {method: a, url: b}))
     }
    })
   ...
   (function (a) {
    n(arguments, function (a) {
     k[a] = function (b, c, d) {
      return k(O(d || {}, {method: a, url: b, data: c}))
     }
    })
   })("post", "put", "patch");
   k.defaults =
 ...
 function Ze() {
  this.$get = ["$browser", "$window", "$document", function (b, a, c) {
   return Mf(b, Lf, b.defer, a.angular.callbacks, c[0])
  }]
 }
 ...
 function Mf(b, a, c, d, e) {
  function f(a, b, c) {
   ...
   m = function (a) {
    ...
    f = null;
    var g = -1, y = "unknown";
    a && ("load" !== a.type || d[b].called || (a = {type: "error"}), y = a.type,
  ...
  return function (e, h, l, k, m, r, s, y) {
   function H() {
    p && p();
    w && w.abort()
   }
   ...
   if ("jsonp" == F(e)) {
    ...
    var p = f(h.replace("JSON_CALLBACK", "angular.callbacks." + u), u,
        function (a, b) {
         J(k, a, d[u].data, "", b);
         d[u] = x
        })
    ...
    w.onload = function () {
     ...
     J(k, c, b, w.getAllResponseHeaders(), a)
    };
    e = function () {
     J(k, -1, null, null, "")
    };
   ...
   function h(f, h, m, r) {
    function u(a) {
     try {
      ...
      var c;
      if (r && !z(a))c = a; else if (null == a)c = ""; else {
       switch (typeof a) {
        case "string":
         break;
        case "number":
    ...
    r = !!r;
    for (var p, n, q = 0, K = [], B = [], N = f.length, A = [], R = []; q < N;)if (-1 != (p = f.indexOf(b, q)) && -1 != (n = f.indexOf(a, p + l)))q !== p && A.push(g(f.substring(q, p))), q = f.substring(p + l, n), K.push(q), B.push(c(q, u)), q = n + k, R.push(A.length), A.push(""); else {
     q !== N && A.push(g(f.substring(q)));
     break
    }
    m && 1 < A.length && Ha.throwNoconcat(f);
    if (!h || K.length) {
     var Y = function (a) {
     ...
     return O(function (a) {
      ...
      exp: f, expressions: K, $$watchDelegate: function (a, b) {
       var c;
 ...
 function Ve() {
  this.$get = ["$rootScope", "$window", "$q", "$$q", function (b, a, c, d) {
   function e(e,
              h, l, k) {
    var m = 4 < arguments.length, r = m ? pa.call(arguments, 4) : [], s = a.setInterval, y = a.clearInterval, H = 0, J = z(k) && !k, u = (J ? d : c).defer(), p = u.promise;
    l = z(l) ? l : 0;
    ...
    p.$$intervalId = s(function () {
     u.notify(H++);
     0 < l && H >= l && (u.resolve(H), y(p.$$intervalId), delete f[p.$$intervalId]);
     J || b.$apply()
    }, h);
    f[p.$$intervalId] = u;
    return p
 ...
 function bd(b, a) {
  ...
  a.$$host = c.hostname;
  a.$$port = aa(c.port) || Nf[c.protocol] || null
 }
 ...
 function ac(b, a) {
  ...
  this.$$parse = function (a) {
   var b = xa(c, a);
   if (!M(b))throw zb("ipthprfx", a, c);
   cd(b, this);
   this.$$path || (this.$$path = "/");
   this.$$compose()
  };
  this.$$compose = function () {
   var a = Nb(this.$$search), b = this.$$hash ? "#" + kb(this.$$hash) : "";
 ...
 function bc(b, a) {
  ...
  this.$$parse = function (d) {
   d = xa(b, d) || xa(c, d);
   var e;
   "#" === d.charAt(0) ? (e = xa(a, d), v(e) && (e = d)) : e = this.$$html5 ? d : "";
   cd(e, this);
   d = this.$$path;
   var f = /^\/[A-Z]:(\/.*)/;
  ...
  this.$$compose = function () {
   var c = Nb(this.$$search), e = this.$$hash ? "#" + kb(this.$$hash) : "";
 ...
 function $e() {
  ...
  this.html5Mode = function (b) {
   return Va(b) ? (a.enabled = b, this) : D(b) ? (Va(b.enabled) && (a.enabled =
  ...
  this.$get = ["$rootScope", "$browser", "$sniffer", "$rootElement", "$window", function (c, d, e, f, g) {
   ...
   var r = d.url(), s;
   if (a.enabled) {
    if (!m && a.requireBase)throw zb("nobase");
   ...
   f.on("click", function (b) {
    if (a.rewriteLinks && !b.ctrlKey && !b.metaKey && !b.shiftKey && 2 != b.which && 2 != b.button) {
     for (var e = C(b.target); "a" !== ra(e[0]);)if (e[0] === f[0] || !(e = e.parent())[0])return;
     var h = e.prop("href"), l = e.attr("href") || e.attr("xlink:href");
     D(h) && "[object SVGAnimatedString]" === h.toString() && (h = za(h.animVal).href);
   ...
   yb(k.absUrl()) != yb(r) && d.url(k.absUrl(), !0);
   var H = !0;
   ...
   c.$watch(function () {
    var a = yb(d.url()), b = yb(k.absUrl()), f = d.state(), g = k.$$replace, m = a !== b || k.$$html5 && e.history && f !== k.$$state;
 ...
 function fd(b, a) {
  if (b) {
   if (b.constructor === b)throw ca("isecfn", a);
   if (b === Of || b === Pf || b === Qf)throw ca("isecff",
       a);
  }
 }
 ...
 function jd(b) {
  if (1 ===
      b.body.length && id(b.body[0].expression))return {
 ...
 function cc(b) {
  return E(b.valueOf) ? b.valueOf() : Sf.call(b)
 }
 ...
 function bf() {
  ...
  this.$get = ["$filter", "$sniffer", function (c, d) {
   function e(a, b) {
    return null == a || null == b ? a === b : "object" === typeof a && (a = cc(a), "object" === typeof a) ? !1 : a === b || a !== a && b !== b
   }
   ...
   function f(a, b, c, d, f) {
    ...
    if (1 === g.length) {
     ...
     return a.$watch(function (a) {
      var b =
          g(a);
      e(b, l) || (h = d(a, t, t, [b]), l = b && cc(b));
      return h
     }, b, c, f)
    }
    for (var k = [], m = [], r = 0, A = g.length; r < A; r++)k[r] = e, m[r] = null;
    return a.$watch(function (a) {
     for (var b = !1, c = 0, f = g.length; c < f; c++) {
      var l = g[c](a);
      if (b || (b = !e(l, k[c])))m[c] = l, k[c] = l && cc(l)
     }
     b && (h = d(a, t, t, m));
     return h
    }, b, c, f)
   ...
   return function (d, e, H) {
    ...
    switch (typeof d) {
     case "string":
      ...
      var q = H ? a : b;
      n = q[p];
      n || (":" === d.charAt(0) && ":" === d.charAt(1) && (u = !0, d = d.substring(2)), H = H ? r : m, n = new dc(H), n = (new ec(n, c, H)).parse(d), n.constant ? n.$$watchDelegate = l : u ? n.$$watchDelegate = n.literal ? h : g : n.inputs && (n.$$watchDelegate = f), q[p] = n);
      return k(n,
          e);
     case "function":
      return k(d, e);
 ...
 function of() {
  this.$get = ["$window", "$timeout", function (b, a) {
   var c = b.requestAnimationFrame || b.webkitRequestAnimationFrame, d = b.cancelAnimationFrame || b.webkitCancelAnimationFrame ||
       b.webkitCancelRequestAnimationFrame, e = !!c, f = e ? function (a) {
    var b = c(a);
    return function () {
     d(b)
    }
 ...
 function cf() {
  ...
  this.$get = ["$injector", "$exceptionHandler", "$parse", "$browser", function (f, g, h, l) {
   ...
   m.prototype = {
    constructor: m, $new: function (a, c) {
     ...
     function c(a) {
      ...
      var b, d, g, h;
      if (!v(e)) {
       if (D(e))if (Qa(e))for (f !== r && (f = r, n = f.length = 0, k++), a = e.length, n !== a && (k++, f.length = n = a), b = 0; b < a; b++)h = f[b],
           g = e[b], d = h !== h && g !== g, d || h === g || (k++, f[b] = g); else {
        f !== s && (f = s = {}, n = 0, k++);
        a = 0;
     ...
     return this.$watch(m, function () {
      ...
      {}, e)tc.call(e, a) && (g[a] = e[a]); else g = e
     })
    }, $digest: function () {
     var b, f, h, k, m, s, n = a, y, K = [], u, v;
     r("$digest");
     l.$$checkUrlChange();
     this === p && null !== e && (l.defer.cancel(e), t());
     d = null;
     do {
      s = !1;
      for (y = this; w.length;) {
      ...
      a:do {
       if (k = y.$$watchers)for (m = k.length; m--;)try {
        if (b = k[m])if ((f = b.get(y)) !== (h = b.last) && !(b.eq ? ja(f, h) : "number" === typeof f && "number" === typeof h && isNaN(f) && isNaN(h)))s = !0, d = b, b.last = b.eq ? sa(f, null) : f, b.fn(f, h === q ? f : h, y), 5 >
        n && (u = 4 - n, K[u] || (K[u] = []), K[u].push({
      ...
      if ((s || w.length) && !n--)throw p.$$phase = null, c("infdig", a, K);
     } while (s || w.length);
     ...
     p.$$phase || w.length || l.defer(function () {
      w.length && p.$digest()
     });
     ...
     for (var f = Xa([e], arguments, 1), h, l; c = d;) {
      e.currentScope = c;
      d = c.$$listeners[a] ||
          [];
      h = 0;
   ...
   var p = new m, w = p.$$asyncQueue = [], z = p.$$postDigestQueue = [], K = p.$$applyAsyncQueue = [];
   return p
  }]
 }
 ...
 function Tf(b) {
  ...
  if (M(b)) {
   ...
   b = od(b).replace("\\*\\*", ".*").replace("\\*", "[^:/.?&;]*");
   return new RegExp("^" + b + "$")
  }
  if (Ta(b))return new RegExp("^" + b.source + "$");
  throw Ba("imatcher");
 }
   ...
   return {
    trustAs: function (a, b) {
     ...
     if (c === ma.RESOURCE_URL) {
      var g = za(e.toString()), r, s, y = !1;
      r = 0;
      for (s = b.length; r < s; r++)if (d(b[r], g)) {
       y = !0;
       break
      }
      if (y)for (r = 0, s = a.length; r < s; r++)if (d(a[r], g)) {
       y = !1;
       break
      }
      if (y)return e;
 ...
 function hf() {
  this.$get = ["$window", "$document", function (b, a) {
   var c = {}, d = aa((/android (\d+)/.exec(F((b.navigator || {}).userAgent)) || [])[1]), e = /Boxee/i.test((b.navigator || {}).userAgent), f = a[0] || {}, g, h = /^(Moz|webkit|ms)(?=[A-Z])/, l = f.body && f.body.style, k = !1, m = !1;
   if (l) {
    ...
    l);
    !d || k && m || (k = M(l.webkitTransition), m = M(l.webkitAnimation))
   }
   return {
  ...
  this.$get = ["$templateCache", "$http", "$q", function (b, a, c) {
   function d(e, f) {
    ...
    return a.get(e, {cache: b, transformResponse: g})["finally"](function () {
     ...
     if (!f)throw ha("tpload", e, a.status, a.statusText);
     return c.reject(a)
    })
   }
   ...
   return {
    findBindings: function (a, b, c) {
     ...
     n(a, function (a) {
      ...
      d &&
      n(d, function (d) {
       c ? (new RegExp("(^|\\s)" + od(b) + "(\\s|\\||$)")).test(d) && g.push(a) : -1 != d.indexOf(b) && g.push(a)
      })
     });
     return g
 ...
 function mf() {
  this.$get = ["$rootScope", "$browser",
   "$q", "$$q", "$exceptionHandler", function (b, a, c, d, e) {
    function f(f, l, k) {
     E(f) || (k = l, l = f, f = x);
     var m = pa.call(arguments, 3), r = z(k) && !k, s = (r ? d : c).defer(), n = s.promise, q;
     q = a.defer(function () {
      try {
 ...
 function za(b) {
  fb &&
  (X.setAttribute("href", b), b = X.href);
 ...
 function ad(b) {
  b = M(b) ? za(b) : b;
  return b.protocol === qd.protocol && b.host === qd.host
 }
 ...
 function rd(b) {
  ...
  return function () {
   var b, g, h, l, k;
   b = c.cookie || "";
   if (b !== e)for (e = b, b = e.split("; "), d = {}, h = 0; h < b.length; h++)g = b[h], l = g.indexOf("="), 0 < l && (k = a(g.substring(0, l)), d[k] === t && (d[k] = a(g.substring(l + 1))));
   return d
  }
 }
 ...
 function Zf(b, a, c) {
  var d = D(b) && "$"in b;
  !0 === a ? a = ja : E(a) || (a = function (a, b) {
   if (v(a))return !1;
   if (null === a || null === b)return a ===
       b;
   var c;
   !(c = D(b)) && (c = D(a)) && (c = a, c = !(E(c.toString) && c.toString !== Object.prototype.toString));
   if (c)return !1;
   a = F("" + a);
   b = F("" + b);
  ...
  return function (e) {
   return d && !D(e) ? Ia(e, b.$, a, !1) : Ia(e, b, a, c)
  }
 }
 ...
 function Ia(b, a, c, d, e) {
  ...
  if (L(b))return b.some(function (b) {
   return Ia(b, a, c, d)
  });
  switch (f) {
   case "object":
    ...
    if ("object" ===
        g) {
     for (h in a)if (e = a[h], !E(e) && !v(e) && (f = "$" === h, !Ia(f ? b : b[h], e, c, f, f)))return !1;
     return !0
    }
    return c(b, a);
   case "function":
 ...
 function sd(b) {
  ...
  return function (b, d, e) {
   ...
   return null == b ? b : wd(b, a.PATTERNS[1], a.GROUP_SEP, a.DECIMAL_SEP, e).replace(/\u00A4/g, d)
  }
 }
 ...
 function ud(b) {
  var a = b.NUMBER_FORMATS;
  return function (b, d) {
   return null == b ? b : wd(b, a.PATTERNS[0], a.GROUP_SEP,
       a.DECIMAL_SEP, d)
  }
 }
 ...
 function wd(b, a, c, d, e) {
  ...
  if (g || k)0 < e && 1 > b && (l = b.toFixed(e), b = parseFloat(l)); else {
   g = (h.split(xd)[1] || "").length;
   v(e) && (e = Math.min(Math.max(a.minFrac, g), a.maxFrac));
   b = +(Math.round(+(b.toString() + "e" + e)).toString() + "e" + -e);
   var g = ("" + b).split(xd), h = g[0], g =
       g[1] || "", r = 0, s = a.lgSize, n = a.gSize;
 ...
 function Eb(b, a) {
  return function (c, d) {
   var e = c["get" + b](), f = nb(a ? "SHORT" + b : b);
   return d[f][e]
  }
 }
 ...
 function td(b) {
  ...
  return function (c, e, f) {
   var g = "", h = [], l, k;
   e = e || "mediumDate";
   e = b.DATETIME_FORMATS[e] ||
       e;
   M(c) && (c = $f.test(c) ? aa(c) : a(c));
   T(c) && (c = new Date(c));
   if (!ea(c) || !isFinite(c.getTime()))return c;
   for (; e;)(k = ag.exec(e)) ? (h = Xa(h, k, 1), e = h.pop()) : (h.push(e), e = null);
   var m = c.getTimezoneOffset();
   f && (m = qc(f, c.getTimezoneOffset()), c = Mb(c, f, !0));
   n(h, function (a) {
    l = bg[a];
 ...
 function vd(b) {
  return function (a, c, d) {
   ...
   return pa.call(a).sort(e(function (a, b) {
 ...
 function Ad(b, a, c, d, e) {
  var f = this, g = [], h = f.$$parentForm = b.parent().controller("form") || Fb;
  f.$error = {};
  f.$$success = {};
  f.$pending = t;
  ...
  f.$setPristine = function () {
   d.setClass(b, Pa, Gb + " ng-submitted");
   f.$dirty = !1;
   f.$pristine = !0;
   f.$submitted = !1;
   n(g, function (a) {
 ...
 function gb(b, a, c, d, e, f) {
  ...
  var l = function (b) {
   ...
   if (!h) {
    var e = a.val();
    b = b && b.type;
    "password" === g || c.ngTrim && "false" === c.ngTrim || (e = S(e));
  ...
  return function (c, d) {
   ...
   if (M(c)) {
    '"' == c.charAt(0) && '"' == c.charAt(c.length - 1) && (c = c.substring(1,
        c.length - 1));
    if (cg.test(c))return new Date(c);
    b.lastIndex = 0;
 ...
 function hb(b, a, c, d) {
  return function (e, f, g, h, l, k, m) {
   ...
   h.$parsers.push(function (b) {
    return h.$isEmpty(b) ? null : a.test(b) ? (b = c(b, q), n && (b = Mb(b, n)), b) : t
   });
   h.$formatters.push(function (a) {
    if (a && !ea(a))throw Ib("datefmt", a);
    if (r(a))return (q = a) && n && (q = Mb(q, n, !0)), m("date")(a, d, n);
    q = null;
    return ""
   });
   if (z(g.min) || g.ngMin) {
 ...
 function Dd(b, a, c, d, e) {
  if (z(d)) {
   b = b(d);
   if (!b.constant)throw G("ngModel")("constexpr", c, d);
   return b(a)
  }
  return e
 }
 ...
 function ic(b, a) {
  ...
  return ["$animate", function (c) {
   function d(a, b) {
    ...
    a:for (; d < a.length; d++) {
     for (var e =
         a[d], m = 0; m < b.length; m++)if (e == b[m])continue a;
     c.push(e)
    }
    return c
   }
   ...
   function e(a) {
    ...
    return L(a) ? (n(a, function (a) {
     b = b.concat(e(a))
    }), b) : M(a) ? a.split(" ") : D(a) ? (n(a, function (a, c) {
 ...
 function Bd(b) {
  ...
  f[Ed] = !(f[ib] = e.hasClass(ib));
  d.$setValidity = function (b, e, f) {
   e === t ? (d.$pending || (d.$pending = {}), g(d.$pending, b, f)) : (d.$pending && h(d.$pending, b, f), Fd(d.$pending) && (d.$pending = t));
   Va(e) ? e ? (h(d.$error, b, f), g(d.$$success, b, f)) : (g(d.$error, b, f), h(d.$$success, b, f)) : (h(d.$error, b, f), h(d.$$success, b, f));
   d.$pending ? (a(Gd, !0), d.$valid = d.$invalid = t, c("", null)) : (a(Gd, !1), d.$valid =
       Fd(d.$error), d.$invalid = !d.$valid, c("", d.$valid));
 ...
 var dg = /^\/(.+)\/([a-z]*)$/, F = function (b) {
  return M(b) ? b.toLowerCase() : b
 }, tc = Object.prototype.hasOwnProperty, nb = function (b) {
  return M(b) ? b.toUpperCase() : b
 }, fb, C, ka, pa = [].slice, Gf = [].splice, eg = [].push, qa = Object.prototype.toString, Ca = G("ng"), ba = Q.angular || (Q.angular = {}), bb, jb = 0;
 fb = V.documentMode;
 x.$inject =
     [];
 Sa.$inject = [];
 var L = Array.isArray, nc = /^\[object (Uint8(Clamped)?)|(Uint16)|(Uint32)|(Int8)|(Int16)|(Int32)|(Float(32)|(64))Array\]$/, S = function (b) {
  return M(b) ? b.trim() : b
 }, od = function (b) {
  return b.replace(/([-()\[\]{}+?*.$\^|,:#<!\\])/g, "\\$1").replace(/\x08/g, "\\x08")
 }, ab = function () {
  if (z(ab.isActive_))return ab.isActive_;
  ...
  var b, a, c = Ka.length, d, e;
  for (a = 0; a < c; ++a)if (d = Ka[a], b = V.querySelector("[" + d.replace(":", "\\:") + "jq]")) {
   e = b.getAttribute(d + "jq");
   break
  }
  return lb.name_ = e
 }, Ka = ["ng-", "data-ng-", "ng:", "x-ng-"], Wd = /[A-Z]/g, wc = !1, Ob, na = 1, Za = 3, $d = {
  full: "1.4.0-rc.1",
  major: 1,
  minor: 4,
  dot: 0,
 ...
 var tf = /([\:\-\_]+(.))/g, uf = /^moz([A-Z])/, fg = {
      mouseleave: "mouseout",
      mouseenter: "mouseover"
     }, Rb = G("jqLite"),
     xf = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, Qb = /<|&#?\w+;/, vf = /<([\w:]+)/, wf = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, ga = {
 ...
 var La = P.prototype = {
  ready: function (b) {
   ...
   var c = !1;
   "complete" === V.readyState ? setTimeout(a) : (this.on("DOMContentLoaded", a), P(Q).on("load", a))
  }, toString: function () {
   var b = [];
   n(this, function (a) {
    b.push("" + a)
  ...
  }, length: 0, push: eg, sort: [].sort, splice: [].splice
 }, xb = {};
 ...
 n({data: Tb, removeData: qb}, function (b, a) {
  P[a] = b
 });
 n({
  data: Tb, inheritedData: wb, scope: function (b) {
   return C.data(b, "$scope") || wb(b.parentNode || b, ["$isolateScope", "$scope"])
   ...
   b.removeAttribute(a)
  }, hasClass: tb, css: function (b,
                                  a, c) {
   a = cb(a);
   if (z(c))b.style[a] = c; else return b.style[a]
  }, attr: function (b, a, c) {
   var d = b.nodeType;
   if (d !== Za && 2 !== d && 8 !== d)if (d = F(a), xb[d])if (z(c))c ? (b[a] = !0, b.setAttribute(a, d)) : (b[a] = !1, b.removeAttribute(d)); else return b[a] || (b.attributes.getNamedItem(a) || x).specified ? d : t; else if (z(c))b.setAttribute(a, c); else if (b.getAttribute)return b = b.getAttribute(a, 2), null === b ? t : b
  }, prop: function (b, a, c) {
  ...
  P.prototype[a] = function (a, d) {
   ...
   if (b !== Lc && (2 == b.length && b !== tb && b !== Kc ? a : d) === t) {
    if (D(a)) {
     for (e = 0; e < g; e++)if (b === Tb)b(this[e], a); else for (f in a)b(this[e],
         f, a[f]);
     return this
    }
    e = b.$dv;
 ...
 n({
  removeData: qb, on: function a(c, d, e, f) {
   if (z(f))throw Rb("onargs");
   if (Gc(c)) {
    var g = rb(c, !0);
    f = g.events;
    var h = g.handle;
    ...
    for (var g = 0 <= d.indexOf(" ") ? d.split(" ") : [d], l = g.length; l--;) {
     d = g[l];
     var k = f[d];
     k || (f[d] = [], "mouseenter" === d || "mouseleave" === d ? a(c, fg[d], function (a) {
  ...
  }, addClass: vb, removeClass: ub, toggleClass: function (a,
                                                           c, d) {
  ...
  }, clone: Sb, triggerHandler: function (a, c, d) {
   var e, f, g = c.type || c, h = rb(a);
   ...
   }, c.type && (e = O(e, c)), c = fa(h), f = d ? [e].concat(d) : [e], n(c, function (c) {
    e.isImmediatePropagationStopped() || c.apply(a, f)
   })
  }
 }, function (a, c) {
  P.prototype[c] = function (c, e, f) {
   for (var g, h = 0, l = this.length; h < l; h++)v(g) ? (g = a(this[h], c, e, f), z(g) && (g = C(g))) : Ic(g, a(this[h], c, e, f));
   return z(g) ? g : this
  };
 ...
 }], Qc = /^function\s*[^\(]*\(\s*([^\)]*)\)/m, gg = /,/, hg = /^\s*(_?)(\S+?)\1\s*$/, Pc = /((\/\/.*$)|(\/\*[\s\S]*?\*\/))/mg, Ea = G("$injector");
 $a.$$annotate = function (a, c, d) {
  var e;
  if ("function" === typeof a) {
   if (!(e = a.$inject)) {
    e = [];
    if (a.length) {
     if (c)throw M(d) && d || (d = a.name || Cf(a)), Ea("strictdi", d);
     c = a.toString().replace(Pc,
         "");
     c = c.match(Qc);
     n(c[1].split(gg), function (a) {
      a.replace(hg, function (a, c, d) {
       e.push(d)
      })
     })
    }
  ...
  } else L(a) ? (c = a.length - 1, Ma(a[c], "fn"), e = a.slice(0, c)) : Ma(a, "fn", !0);
  return e
 };
 var ig = G("$animate"), Oe = function () {
  this.$get = ["$q", "$$rAF", function (a, c) {
   ...
   d.chain = x;
   d.prototype = {
    end: x, cancel: x, resume: x, pause: x, complete: x, then: function (d, f) {
     return a(function (a) {
      c(function () {
       a()
      })
  ...
  this.$get = ["$$AnimateRunner", "$rootScope",
   function (d, e) {
    ...
    return {
     enabled: x, on: x, off: x, pin: x, push: function (a, c, e, k) {
      k && k();
      e = e || {};
      e.from &&
      a.css(e.from);
  ...
  this.register = function (d, e) {
   if (d && "." !== d.charAt(0))throw ig("notcsel", d);
   var f = d + "-animation";
   ...
   function (a) {
    ...
    return {
     ...
     addClass: function (c, e, h) {
      h = h || {};
      h.addClass = db(h.addclass, e);
      return a.push(c, "addClass", h)
     }, removeClass: function (c, e, h) {
      h = h || {};
      h.removeClass = db(h.removeClass, e);
      return a.push(c, "removeClass", h)
     }, setClass: function (c, e, h, l) {
      l = l || {};
      l.addClass = db(l.addClass, e);
      l.removeClass = db(l.removeClass, h);
      return a.push(c, "setClass", l)
     }, animate: function (c, e, h, l, k) {
      k = k || {};
      k.from = k.from ? O(k.from, e) : e;
      k.to = k.to ? O(k.to, h) : h;
      k.tempClasses = db(k.tempClasses, l || "ng-inline-animate");
 ...
 var Tc = /^((?:x|data)[\:\-_])/i, Hf = G("$controller"), Rc = /^(\S+)(\s+as\s+(\w+))?$/, Xc = "application/json", Yb = {"Content-Type": Xc + ";charset=utf-8"}, Jf = /^\[|^\{(?!\{)/, Kf = {
  "[": /]$/,
  "{": /}$/
 }, If = /^\)\]\}',?\n/, Ha = ba.$interpolateMinErr = G("$interpolate");
 Ha.throwNoconcat = function (a) {
  throw Ha("noconcat", a);
 };
 Ha.interr = function (a, c) {
  return Ha("interr", a, c.toString())
 };
 var jg = /^([^\?#]*)(\?([^#]*))?(#(.*))?$/, Nf = {http: 80, https: 443, ftp: 21}, zb = G("$location"),
     kg = {
      $$html5: !1, $$replace: !1, absUrl: Ab("$$absUrl"), url: function (a) {
       ...
       this.hash(c[5] || "");
       return this
      }, protocol: Ab("$$protocol"), host: Ab("$$host"), port: Ab("$$port"), path: ed("$$path", function (a) {
       a = null !== a ? a.toString() : "";
       ...
       switch (arguments.length) {
        case 0:
         return this.$$search;
        case 1:
         if (M(a) || T(a))a = a.toString(), this.$$search =
             sc(a); else if (D(a))a = sa(a, {}), n(a, function (c, e) {
          null == c && delete a[e]
         }), this.$$search = a; else throw zb("isrcharg");
         break;
        default:
 ...
 n([dd, bc, ac], function (a) {
  a.prototype = Object.create(kg);
  a.prototype.state = function (c) {
   if (!arguments.length)return this.$$state;
   if (a !== ac || !this.$$html5)throw zb("nostate");
   this.$$state =
       v(c) ? null : c;
   return this
  }
 });
 var ca = G("$parse"), Of = Function.prototype.call, Pf = Function.prototype.apply, Qf = Function.prototype.bind, Jb = la();
 n("+ - * / % === !== == != < > <= >= && || ! = |".split(" "), function (a) {
  Jb[a] = !0
 });
 ...
 dc.prototype = {
  constructor: dc, lex: function (a) {
   ...
   d = d || this.index;
   c = z(c) ? "s " + c + "-" + this.index + " [" + this.text.substring(c,
       d) + "]" : " " + d;
   ...
   for (var d = "", e = a, f = !1; this.index < this.text.length;) {
    ...
    this.throwError("Invalid unicode escape [\\u" + f + "]"), this.index += 4, d += String.fromCharCode(parseInt(f, 16))) : d += lg[g] || g, f = !1; else if ("\\" === g)f = !0; else {
     if (g === a) {
      this.index++;
 ...
 q.prototype = {
  ast: function (a) {
   ...
   this.expect("(") ? (a = this.filterChain(), this.consume(")")) :
       this.expect("[") ? a = this.arrayDeclaration() : this.expect("{") ? a = this.object() : this.constants.hasOwnProperty(this.peek().text) ? a = sa(this.constants[this.consume().text]) : this.peek().identifier ? a = this.identifier() : this.peek().constant ? a = this.constant() : this.throwError("not a primary expression", this.peek());
   ...
   "true": {type: q.Literal, value: !0}, "false": {type: q.Literal, value: !1}, "null": {
    type: q.Literal,
    value: null
   }, undefined: {type: q.Literal, value: t}, "this": {type: q.ThisExpression}
  }
 };
 ld.prototype = {
  compile: function (a, c) {
   ...
   var f = "", g;
   this.stage = "assign";
   if (g = jd(e))this.state.computing = "assign", f = this.nextId(), this.recurse(g, f), f = "fn.assign=" + this.generateFunction("assign", "s,v,l");
   g = hd(e.body);
   d.stage = "inputs";
   n(g, function (a, c) {
    var e =
   ...
   f = (new Function("$filter", "ensureSafeMemberName", "ensureSafeObject", "ensureSafeFunction", "ifDefined", "plus", "text", f))(this.$filter, Aa, ia, fd, Rf, gd, a);
   this.state =
       this.stage = t;
   f.literal = kd(e);
   ...
   if (!g && z(a.watchId))c = c || this.nextId(), this.if_("i", this.lazyAssign(c, this.computedMember("i", a.watchId)), this.lazyRecurse(a, c, d, e, f, !0)); else switch (a.type) {
    ...
    case q.Identifier:
     ...
     (k.state.expensiveChecks || Cb(a.name)) && k.addEnsureSafeObject(c);
     e(c);
     break;
    case q.MemberExpression:
     ...
     k.recurse(a.object, h, t, function () {
      k.if_(k.notNull(h), function () {
       if (a.computed)l =
        ...
        if (k.state.expensiveChecks || Cb(a.property.name))r = k.ensureSafeObject(r);
        k.assign(c,
            r);
 ...
 md.prototype = {
  compile: function (a, c) {
   ...
   switch (a.type) {
    ...
    case q.Identifier:
     return Aa(a.name, g.expression), g.identifier(a.name, g.expensiveChecks || Cb(a.name), c, d, g.expression);
    case q.MemberExpression:
     return e = this.recurse(a.object, !1, !!d), a.computed || (Aa(a.property.name, g.expression), f = a.property.name), a.computed && (f = this.recurse(a.property)), a.computed ? this.computedMember(e, f, c, d, g.expression) : this.nonComputedMember(e, f,
    ...
    case q.CallExpression:
     return h = [], n(a.arguments, function (a) {
      ...
      var n = f(a, d, e, r), q;
      if (null != n.value) {
       ia(n.context, g.expression);
       fd(n.value, g.expression);
       q = [];
       for (var t = 0; t < h.length; ++t)q.push(ia(h[t](a, d, e, r),
           g.expression));
       q = ia(n.value.apply(n.context, q), g.expression)
      }
      return c ? {value: q} : q
     };
    case q.AssignmentExpression:
  ...
  computedMember: function (a, c, d, e, f) {
   return function (g, h, l, k) {
    var m = a(g, h, l, k), n, s;
    null != m && (n = c(g, h, l, k), Aa(n, f), e && 1 !== e && m && !m[n] && (m[n] = {}), s = m[n], ia(s, f));
 ...
 var ec = function (a, c, d) {
  this.lexer = a;
  this.$filter =
      c;
  this.options = d;
  this.ast = new q(this.lexer);
  this.astCompiler = d.csp ? new md(this.ast, c) : new ld(this.ast, c)
 };
 ec.prototype = {
  constructor: ec, parse: function (a) {
   return this.astCompiler.compile(a, this.options.expensiveChecks)
  }
 };
 la();
 la();
 var Sf = Object.prototype.valueOf, Ba = G("$sce"), ma = {
  HTML: "html",
  CSS: "css",
  URL: "url",
  RESOURCE_URL: "resourceUrl",
  JS: "js"
 }, ha = G("$compile"), X = V.createElement("a"), qd = za(Q.location.href);
 rd.$inject = ["$document"];
 Fc.$inject = ["$provide"];
 sd.$inject = ["$locale"];
 ud.$inject = ["$locale"];
 var xd = ".", bg = {
  ...
  Z: function (a, c, d) {
   a = -1 * d;
   return a = (0 <= a ? "+" : "") + (Db(Math[0 < a ? "floor" :
           "ceil"](a / 60), 2) + Db(Math.abs(a % 60), 2))
  },
  ww: zd(2),
  w: zd(1),
  G: gc,
 ...
 }, ag = /((?:[^yMdHhmsaZEwG']+)|(?:'(?:[^']|'')*')|(?:E+|y+|M+|d+|H+|h+|m+|s+|a|Z|G+|w+))(.*)/, $f = /^\-?\d+$/;
 td.$inject = ["$locale"];
 var Xf = oa(F), Yf = oa(nb);
 vd.$inject = ["$parse"];
 var ce = oa({
  restrict: "E", compile: function (a, c) {
   if (!c.href && !c.xlinkHref)return function (a, c) {
    if ("a" === c[0].nodeName.toLowerCase()) {
     var f = "[object SVGAnimatedString]" === qa.call(c.prop("href")) ?
         "xlink:href" : "href";
  ...
  ob[c] = function () {
   return {
    priority: 100, link: function (a, e, f) {
     if ("ngPattern" === c && "/" == f.ngPattern.charAt(0) && (e = f.ngPattern.match(dg))) {
      f.$set("ngPattern",
          new RegExp(e[1], e[2]));
      return
     }
  ...
  ob[c] = function () {
   return {
    priority: 99, link: function (d, e, f) {
     var g = a, h = a;
     "href" === a && "[object SVGAnimatedString]" === qa.call(e.prop("href")) && (h = "xlinkHref", f.$attr[h] = "xlink:href", g = null);
 ...
 var Fb = {
  $addControl: x, $$renameControl: function (a, c) {
   a.$name = c
  }, $removeControl: x, $setValidity: x,
  $setDirty: x, $setPristine: x, $setSubmitted: x
 };
 Ad.$inject = ["$element", "$attrs", "$scope", "$animate", "$interpolate"];
 var Hd = function (a) {
      return ["$timeout", function (c) {
       return {
        name: "form", restrict: a ? "EAC" : "E", controller: Ad, compile: function (d, e) {
         d.addClass(Pa).addClass(ib);
         ...
         return {
          pre: function (a, d, e, k) {
           ...
           var n = k.$$parentForm;
           f && (Bb(a, k.$name, k, k.$name), e.$observe(f, function (c) {
            k.$name !== c && (Bb(a, k.$name, t, k.$name), n.$$renameControl(k, c), Bb(a, k.$name, k, k.$name))
           }));
     ...
     }, de = Hd(), qe = Hd(!0), cg = /\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d:[0-5]\d\.\d+([+-][0-2]\d:[0-5]\d|Z)/, mg = /^(ftp|http|https):\/\/(\w+:{0,1}\w*@)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?$/,
     ng = /^[a-z0-9!#$%&'*+\/=?^_`{|}~.-]+@[a-z0-9]([a-z0-9-]*[a-z0-9])?(\.[a-z0-9]([a-z0-9-]*[a-z0-9])?)*$/i, og = /^\s*(\-|\+)?(\d+|(\d*(\.\d*)))\s*$/, Id = /^(\d{4})-(\d{2})-(\d{2})$/, Jd = /^(\d{4})-(\d\d)-(\d\d)T(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/, jc = /^(\d{4})-W(\d\d)$/, Kd = /^(\d{4})-(\d\d)$/, Ld = /^(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/, Md = {
      text: function (a, c, d, e, f, g) {
       gb(a, c, d, e, f, g);
       hc(e)
      },
      date: hb("date", Id, Hb(Id, ["yyyy", "MM", "dd"]), "yyyy-MM-dd"),
      "datetime-local": hb("datetimelocal", Jd, Hb(Jd, "yyyy MM dd HH mm ss sss".split(" ")),
          "yyyy-MM-ddTHH:mm:ss.sss"),
      time: hb("time", Ld, Hb(Ld, ["HH", "mm", "ss", "sss"]), "HH:mm:ss.sss"),
      week: hb("week", jc, function (a, c) {
       ...
       if (M(a)) {
        ...
        var d = jc.exec(a);
        if (d) {
         var e = +d[1], f = +d[2], g = d = 0, h = 0, l = 0, k = yd(e), f = 7 * (f - 1);
      ...
      month: hb("month", Kd, Hb(Kd, ["yyyy", "MM"]), "yyyy-MM"),
      number: function (a, c, d, e, f, g) {
       ...
       e.$parsers.push(function (a) {
        return e.$isEmpty(a) ? null : og.test(a) ? parseFloat(a) : t
       });
       e.$formatters.push(function (a) {
        if (!e.$isEmpty(a)) {
         if (!T(a))throw Ib("numfmt", a);
         a = a.toString()
        }
        return a
       });
      ...
      email: function (a, c, d, e, f, g) {
       ...
       e.$validators.email = function (a, c) {
        var d = a || c;
        return e.$isEmpty(d) || ng.test(d)
       }
      },
      radio: function (a, c, d, e) {
       v(d.name) && c.attr("name", ++jb);
       c.on("click", function (a) {
      ...
      checkbox: function (a, c, d, e, f, g, h, l) {
       var k = Dd(l, a, "ngTrueValue", d.ngTrueValue, !0), m = Dd(l, a, "ngFalseValue", d.ngFalseValue, !1);
       c.on("click", function (a) {
       ...
       return {
        restrict: "E", require: ["?ngModel"], link: {
         pre: function (f, g, h, l) {
          l[0] && (Md[F(h.type)] || Md.text)(f, g, h, l[0], c, a, d, e)
         }
        }
       }
      }], pg = /^(true|false|\d+)$/, Ie = function () {
      return {
       restrict: "A", priority: 100, compile: function (a, c) {
        return pg.test(c.ngValue) ? function (a, c, f) {
     ...
     }], ke = ["$interpolate", "$compile", function (a, c) {
      return {
       compile: function (d) {
        c.$$addBindingClass(d);
     ...
     }], je = ["$sce", "$parse", "$compile", function (a, c, d) {
      return {
     ...
     }), le = ic("", !0), ne = ic("Odd", 0), me = ic("Even", 1), oe = Ja({
      compile: function (a, c) {
       c.$set("ngCloak", t);
    ...
    restrict: "A", compile: function (f, g) {
     ...
     return function (c, d) {
      d.on(a, function (d) {
       ...
       qg[a] && e.$$phase ? c.$evalAsync(f) : c.$apply(f)
      })
     }
    }
   }
 ...
 var se = ["$animate", function (a) {
      return {
       ...
       transclude: "element", priority: 600, terminal: !0, restrict: "A", $$tlb: !0, link: function (c, d, e, f, g) {
        ...
        c.$watch(e.ngIf, function (c) {
         ...
         }) : (k && (k.remove(), k = null), l && (l.$destroy(), l = null), h && (k = mb(h.clone), a.leave(k).then(function () {
          k = null
         }), h = null))
        })
       }
      }
     }], te = ["$templateRequest", "$anchorScroll", "$animate", "$sce", function (a, c, d, e) {
      return {
       ...
       controller: ba.noop, compile: function (f, g) {
        ...
        return function (f, g, n, q, t) {
         var v = 0, u, p, w, x = function () {
          p && (p.remove(), p = null);
          u && (u.$destroy(), u = null);
         ...
         f.$watch(e.parseAsResourceUrl(h), function (e) {
          ...
          e ? (a(e, !0).then(function (a) {
           ...
           n === v && (x(), f.$emit("$includeContentError", e))
          }), f.$emit("$includeContentRequested", e)) : (x(), q.template = null)
         })
        }
       }
      }
      ...
      return {
       restrict: "ECA", priority: -400, require: "ngInclude", link: function (c, d, e, f) {
        /SVG/.test(d[0].toString()) ? (d.empty(), a(Hc(f.template, V).childNodes)(c, function (a) {
         d.append(a)
     ...
     Ge = function () {
      return {
       restrict: "A", priority: 100, require: "ngModel", link: function (a, c, d, e) {
        var f = c.attr(d.$attr.ngList) || ", ", g = "false" !== d.ngTrim, h = g ? S(f) : f;
        e.$parsers.push(function (a) {
         if (!v(a)) {
          var c = [];
     ...
     }, ib = "ng-valid", Ed = "ng-invalid", Pa = "ng-pristine", Gb = "ng-dirty", Gd = "ng-pending", Ib = new G("ngModel"), rg = ["$scope", "$exceptionHandler", "$attrs",
      "$element", "$parse", "$animate", "$timeout", "$rootScope", "$q", "$interpolate", function (a, c, d, e, f, g, h, l, k, m) {
       ...
       this.$$setOptions = function (a) {
        if ((p.$options = a) && a.getterSetter) {
         ...
         H = function (a, c) {
          E(r(a)) ? g(a, {$$$p: p.$modelValue}) : s(a, p.$modelValue)
         }
        } else if (!r.assign)throw Ib("nonassign", d.ngModel, ta(e));
       };
       this.$render = x;
       this.$isEmpty = function (a) {
        return v(a) || "" === a || null === a || a !== a
       };
       var w = e.inheritedData("$formController") || Fb, C = 0;
       Bd({
       ...
       this.$validate = function () {
        if (!T(p.$modelValue) || !isNaN(p.$modelValue)) {
       ...
       this.$$runValidators = function (a, c, d) {
        ...
        function f() {
         ...
         n(p.$asyncValidators, function (f, h) {
          var k = f(a, c);
          if (!k || !E(k.then))throw Ib("$asyncValidators", k);
          g(h, t);
        ...
        (function () {
         ...
         if (u === t)g(a, null); else return u || (n(p.$validators, function (a, c) {
          g(c, null)
       ...
       this.$$parseAndValidate = function () {
        ...
        if (u = v(c) ? t : !0)for (var d = 0; d < p.$parsers.length; d++)if (c = p.$parsers[d](c), v(c)) {
         u = !1;
         break
        }
        T(p.$modelValue) && isNaN(p.$modelValue) && (p.$modelValue = q(a));
        var e = p.$modelValue,
       ...
       this.$$debounceViewValueCommit =
           function (c) {
            var d = 0, e = p.$options;
            e && z(e.debounce) && (e = e.debounce, T(e) ? d = e : T(e[c]) ? d = e[c] : T(e["default"]) && (d = e["default"]));
            h.cancel(J);
            d ? J = h(function () {
             p.$commitViewValue()
       ...
       a.$watch(function () {
        ...
        if (c !== p.$modelValue && (p.$modelValue === p.$modelValue || c === c)) {
         ...
         p.$viewValue !== f && (p.$viewValue = p.$$lastCommittedViewValue = f, p.$render(),
             p.$$runValidators(c, f, x))
        }
        return c
       })
      }], Fe = ["$rootScope", function (a) {
      return {
       restrict: "A",
       ...
       priority: 1,
       compile: function (c) {
        c.addClass(Pa).addClass("ng-untouched").addClass(ib);
        return {
     ...
     }], sg = /(\s+|^)default(\s+|$)/, Je = function () {
      return {
       restrict: "A", controller: ["$scope", "$attrs", function (a, c) {
        var d = this;
        this.$options = sa(a.$eval(c.ngModelOptions));
        this.$options.updateOn !== t ? (this.$options.updateOnDefault = !1, this.$options.updateOn = S(this.$options.updateOn.replace(sg, function () {
      ...
      terminal: !0,
      priority: 1E3
     }), tg = G("ngOptions"), ug = /^\s*([\s\S]+?)(?:\s+as\s+([\s\S]+?))?(?:\s+group\s+by\s+([\s\S]+?))?(?:\s+disable\s+when\s+([\s\S]+?))?\s+for\s+(?:([\$\w][\$\w]*)|(?:\(\s*([\$\w][\$\w]*)\s*,\s*([\$\w][\$\w]*)\s*\)))\s+in\s+([\s\S]+?)(?:\s+track\s+by\s+([\s\S]+?))?$/, De = ["$compile", "$parse", function (a, c) {
      function d(a, d, e) {
       ...
       var m = a.match(ug);
       if (!m)throw tg("iexp", a, ta(d));
       var n = m[5] || m[7], q = m[6];
       a = / as /.test(m[0]) && m[1];
       var t = m[9];
       d = c(m[2] ? m[1] : n);
       var v = a && c(a) || d, x = t && c(t), u = t ? function (a, c) {
        return x(e, c)
       } : function (a) {
        return Da(a)
       }, p = c(m[2] || m[1]), w = c(m[3] || ""), z = c(m[4] || ""), C = c(m[8]), B = {}, N = q ? function (a, c) {
        B[q] = c;
        B[n] = a;
        return B
       } : function (a) {
       ...
       return {
        trackBy: t, getWatchables: c(C, function (a) {
         var c = [];
         a = a || [];
         ...
         Object.keys(d).forEach(function (g) {
          if ("$" !== g.charAt(0)) {
           var h = N(d[g], g), m = v(e, h);
           g = u(m, h);
           var n = p(e, h), r = w(e, h), h = z(e, h), m = new f(g, m, n, r, h);
           a.push(m);
           c[g] = m
          }
         });
         return {
          items: a, selectValueMap: c, getOptionFromViewValue: function (a) {
           ...
           return t ? ba.copy(a.viewValue) : a.viewValue
          }
         }
        }
       }
      ...
      var e = V.createElement("option"), f = V.createElement("optgroup");
      return {
       restrict: "A", terminal: !0,
       require: ["select", "?ngModel"], link: function (c, h, l, k) {
        function m(a, c) {
         a.element = c;
        ...
        function q(a) {
         for (var c; a;)c = a.nextSibling, Ub(a), a = c
        }
        ...
        function v() {
         ...
         if (!x.$isEmpty(a)) {
          var g =
              u.readValue();
          if (D.trackBy && !ja(a, g) || a !== g)x.$setViewValue(g), x.$render()
         }
        }
        ...
        if (x) {
         var u = k[0];
         k = l.multiple;
         for (var p, w = 0, z = h.children(), K = z.length; w < K; w++)if ("" === z[w].value) {
          p = z.eq(w);
          break
         }
         var B = !!p, N = C(e.cloneNode(!1));
         N.val("?");
         var A, D = d(l.ngOptions, h, c);
         u.writeValue = function (a) {
          var c = A.getOptionFromViewValue(a);
          c && !c.disabled ? h[0].value !== c.selectValue && (N.remove(), B || p.remove(), h[0].value = c.selectValue, c.element.selected = !0, c.element.setAttribute("selected", "selected")) : null === a ||
          B ? (N.remove(), B || h.prepend(p), h.val(""), p.prop("selected", !0), p.attr("selected", !0)) : (B || p.remove(), h.prepend(N), h.val("?"), N.prop("selected", !0), N.attr("selected", !0))
         };
         u.readValue = function () {
          var a = A.selectValueMap[h.val()];
          return a && !a.disabled ? (B || p.remove(), N.remove(), A.getViewValueFromOption(a)) : null
         };
         k && (x.$isEmpty = function (a) {
          return !a || 0 === a.length
         }, u.writeValue = function (a) {
          A.items.forEach(function (a) {
          ...
          a && a.forEach(function (a) {
           (a = A.getOptionFromViewValue(a)) && !a.disabled &&
           (a.element.selected = !0)
          })
         }, u.readValue = function () {
          var a = h.val() || [], c = [];
          n(a, function (a) {
           a = A.selectValueMap[a];
           a.disabled || c.push(A.getViewValueFromOption(a))
          });
          return c
         });
         B ? (p.remove(), a(p)(c), p.removeClass("ng-scope")) : p = C(e.cloneNode(!1));
         v();
         c.$watchCollection(D.getWatchables, v);
         D.trackBy && c.$watch(l.ngModel, function () {
          x.$render()
         }, !0)
        }
       }
      }
     }], we = ["$locale", "$interpolate", "$log", function (a, c, d) {
      ...
      return {
       link: function (g, h, l) {
        ...
        var m = l.count,
            r = l.$attr.when && h.attr(l.$attr.when), q = l.offset || 0, t = g.$eval(r) || {}, z = {}, C = c.startSymbol(), u = c.endSymbol(), p = C + m + "-" + q + u, w = ba.noop, D;
        n(l, function (a, c) {
         var d = f.exec(c);
         d && (d = (d[1] ? "-" : "") + F(d[2]), t[d] = h.attr(l.$attr[c]))
        });
        n(t, function (a, d) {
         z[d] = c(a.replace(e, p))
        });
        g.$watch(m, function (c) {
         ...
         f || e in t || (e = a.pluralCat(e - q));
         e === D || f && T(D) && isNaN(D) || (w(), f = z[e], v(f) ? (null != c && d.debug("ngPluralize: no rule defined for '" + e + "' in " + r), w = x, k()) : w = g.$watch(f, k), D = e)
        })
       }
      }
     }], xe =
         ["$parse", "$animate", function (a, c) {
          var d = G("ngRepeat"), e = function (a, c, d, e, k, m, n) {
           a[d] = e;
           k && (a[k] = m);
           a.$index = c;
           a.$first = 0 === c;
          ...
          return {
           ...
           compile: function (f, g) {
            var h = g.ngRepeat, l = V.createComment(" end ngRepeat: " + h + " "), k = h.match(/^\s*([\s\S]+?)\s+in\s+([\s\S]+?)(?:\s+as\s+([\s\S]+?))?(?:\s+track\s+by\s+([\s\S]+?))?\s*$/);
            if (!k)throw d("iexp", h);
            ...
            return function (a, f, g, k, m) {
             ...
             a.$watchCollection(r, function (g) {
              var k, r, u = f[0], y, A = la(), E, K, M, G, L, F, O;
              q && (a[q] = g);
              if (Qa(g))L = g, r = p || w; else for (O in r = p || D, L = [], g)g.hasOwnProperty(O) && "$" !== O.charAt(0) && L.push(O);
              E = L.length;
              O = Array(E);
              for (k = 0; k < E; k++)if (K = g === L ? k : L[k], M = g[K], G = r(K, M, k), v[G])F = v[G], delete v[G], A[G] = F, O[k] = F; else {
               if (A[G])throw n(O, function (a) {
                a && a.scope && (v[a.id] = a)
               }), d("dupes", h, G, M);
              ...
              for (y in v) {
               ...
               G = mb(F.clone);
               c.leave(G);
               if (G[0].parentNode)for (k = 0, r = G.length; k <
               r; k++)G[k].$$NG_REMOVED = !0;
               F.scope.$destroy()
              }
              for (k = 0; k < E; k++)if (K = g === L ? k : L[k], M = g[K], F = O[k], F.scope) {
               y = u;
               do y = y.nextSibling; while (y && y.$$NG_REMOVED);
               F.clone[0] != y && c.move(mb(F.clone), null, C(u));
               u = F.clone[F.clone.length - 1];
               e(F.scope, k, x, M, z, K, E)
              } else m(function (a, d) {
               F.scope = d;
               var f = l.cloneNode(!1);
               a[a.length++] = f;
     ...
     Be = Ja({
      ...
      restrict: "EAC", link: function (a, c, d, e, f) {
       if (!f)throw G("ngTransclude")("orphan", ta(c));
       f(function (a) {
        c.empty();
        c.append(a)
       })
     ...
     }], vg = {$setViewValue: x, $render: x}, wg = ["$element", "$scope", "$attrs", function (a, c, d) {
      var e = this, f = new Oa;
      e.ngModelCtrl = vg;
      e.unknownOption = C(V.createElement("option"));
      ...
      return {
       restrict: "E", require: ["select", "?ngModel"], controller: wg, link: function (a, c, d, e) {
        var f = e[1];
        if (f) {
         var g = e[0];
         g.ngModelCtrl = f;
         ...
         if (d.multiple) {
          ...
          var h, l = NaN;
          a.$watch(function () {
           l !== f.$viewValue || ja(h, f.$viewValue) || (h = fa(f.$viewValue), f.$render());
           l = f.$viewValue
          });
      ...
      return {
       restrict: "E", priority: 100, compile: function (d, e) {
        ...
        return function (a, d, e) {
         var k = d.parent(), m =
             k.data("$selectController") || k.parent().data("$selectController");
     ...
     }], ge = oa({restrict: "E", terminal: !1}), Bc = function () {
      return {
       restrict: "A", require: "?ngModel", link: function (a, c, d, e) {
       ...
       restrict: "A", require: "?ngModel", link: function (a, c, d, e) {
        if (e) {
         ...
         d.$observe("pattern", function (a) {
          ...
          if (a && !a.test)throw G("ngPattern")("noregexp", g, a, ta(c));
          f = a || t;
          e.$validate()
         });
 ...
 Q.angular.bootstrap ? console.log("WARNING: Tried to load angular more than once.") : (Xd(), Zd(ba),
     C(V).ready(function () {
      Td(V, uc)
     }))
})(window, document);
