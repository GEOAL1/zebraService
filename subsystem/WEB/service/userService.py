...
import logging
import time
from framework.model import RegisterForm, ReqLogin, ReqcheckPhone, ReqUser, UserFullInfo, Account
...
class UserService(IWebService):
    ...
    def detailUserInfo(self, user_id):
        ...
        acct =  Account({"uid": user_id, "balance": 100, "point": 100})
        # 请求个人信息及个人状态
